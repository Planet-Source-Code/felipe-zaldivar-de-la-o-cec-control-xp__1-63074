...
If Txt_Frase.Text <> "" Then
    ...
    If FrmPrincipal.Conectado(Puerto1) = False Then Exit Sub
    Mensaje = ("AYUDAR¯[®©]¤¤¤" & Puerto1 & "¤¢©§¦[BOLA]¦§©¢¤" & Nivel1 & "¤¢©§¦[BOLA]¦§©¢¤" & Cuenta1 & "¤¢©§¦[BOLA]¦§©¢¤" & Puerto2 & "¤¢©§¦[BOLA]¦§©¢¤" & Nivel2 & "¤¢©§¦[BOLA]¦§©¢¤" & Cuenta2 & "¤¢©§¦[BOLA]¦§©¢¤" & Txt_Frase.Text)
    Call FrmPrincipal.Enviar(Mensaje, Puerto1)
    Txt_Respuesta.Text = Txt_Respuesta.Text & Cuenta2 & ":" & Txt_Frase.Text & Chr(10)
    Txt_Frase.Text = ""
End If
    Txt_Frase.SetFocus
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    Call FrmPrincipal.QuitarVentana(NVIndex)
End Sub
...
Private Sub Txt_Frase_Change()
    If Contador2 = 0 Then
        If Len(Txt_Frase.Text) = 0 Then
            ...
            If FrmPrincipal.Conectado(Puerto1) = True Then
                Call FrmPrincipal.Enviar(Mensaje, Puerto1)
            End If
            DoEvents
        End If
