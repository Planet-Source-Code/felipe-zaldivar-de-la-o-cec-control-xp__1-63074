...
Public Function EnumWindowsProc(ByVal hWnd As Long, ByVal lParam As Long) As Long
    FrmPrincipal.WindowCreated hWnd 'Just pretend we saw the window be created
    ...
    Select Case uMsg
        ...
        Select Case wParam
            Case HSHELL_WINDOWCREATED
                FrmPrincipal.WindowCreated lParam
            Case HSHELL_WINDOWDESTROYED
                FrmPrincipal.WindowDestroyed lParam
            Case HSHELL_REDRAW
                FrmPrincipal.WindowRedraw lParam
            Case HSHELL_WINDOWACTIVATED
                FrmPrincipal.WindowActivated lParam
        End Select
    End Select
